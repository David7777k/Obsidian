...
import org.obsidian.client.api.events.orbit.listeners.ArrayBackedImmutableList;
import org.obsidian.client.api.events.orbit.listeners.IListener;
import org.obsidian.client.api.events.orbit.listeners.LambdaListener;
import org.obsidian.client.api.events.orbit.listeners.ListOperations;
...
public class EventBus implements IEventBus {
    ...
    public <T> T post(T event) {
        ...
        try {
            ...
            e.printStackTrace();
            if (Obsidian.devMode())
                Obsidian.inst().notificationManager().register(ColorFormatting.getColor(255, 0, 0) + "Чекни консоль.", NotificationType.INFO, 3000);
        }
